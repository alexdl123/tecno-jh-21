...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <form role="form" method="post" action="{{route('promociones_store')}}">
                @csrf
                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <label for="nombre_promocion">Nombre</label>
                                <input class="form-control" placeholder="Escriba el nombre.." required
                                    name="nombre_promocion" id="nombre_promocion" type="text">
                        ...
                        <div class="col-lg-6">
                            <label for="porcentaje_promocion">Porcentaje</label>
                                <input class="form-control" placeholder="Escriba el porcentaje.." required
                                    name="porcentaje_promocion" id="porcentaje_promocion" type="number" min="0" max="100">
                        </div>
                    </div>
                    <div class="row pt-2">
