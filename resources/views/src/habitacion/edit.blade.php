...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <form role="form" method="post" action="{{route('habitaciones_update', ['id' => $habitacion->id])}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row pt-2">
                        <div class="col-lg-6">
                            <label for="nrohabitacion_habitacion">Nro Habitacion</label>
                                <input class="form-control" placeholder="Escriba el nro habitacion.." required value="{{$habitacion->nrohabitacion}}"
