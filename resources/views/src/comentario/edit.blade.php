...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0" style="color: #1A7CE7"><b>Comentario</b></h1>
</div>
<div class="col-md-12">
    ...
    <div class="col-md-12 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="{{route('comentarios')}}" class="btn ripple btn-3d btn-primary" style='float:right'>
                    <div><span>Atras</span></div>
                </a>
            </div>
            <form role="form" method="post" action="{{route('comentarios_update', ['id' => $comentario->id])}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row pt-2">
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" required
                                name="titulo" type="text" value="{{ $comentario->titulo }}">
                        </div>
                        <div class="col-lg-6">
                            <label for="comentario">Comentario</label>
                            <textarea class="form-control" required
                                name="comentario" id="comentario" type="text">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select class="form-control" name="huesped_id">
                                ...
                                @if ($comentario->huesped_id == $huesped->id)
