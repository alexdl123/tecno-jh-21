    ...
    <div class="card shadow mb-4">
        @can('crear personal')
            <div class="card-header py-3">
                <a href="{{route('usuarios_create')}}" class="btn ripple btn-3d btn-success" style='float:right'>
                ...
                <table class="table table-bordered table-hover" id="dataTables">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                @can('ver personal')
                                    <a href="{{route('usuarios_show', ['id' => $c->id]) }}"
                                            class="btn btn-primary btn-xs">Ver</a>
                                @endcan
                                @can('editar personal')
                                    <a href="{{route('usuarios_edit', ['id' => $c->id]) }}"
